...
import com.React.Jwt.Login.Entity.Auth.AuthResponse;    //Import DTO class used to transfer user data between layers
...
public interface UserInterface 
{
    ...
    AuthResponse UpdateUserProfile(Long userId, UserDTO userDTO);   //Method to update an existing user
